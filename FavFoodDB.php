...
<?php
    ...
    echo "<tr align='center' bgcolor='#CCCCCC'><td>Menu</td><td>Calories</td><td>Sodium</td><td>Carbohydrates</td><td>Sugars</td><td>Protein</td><td></td></tr>";
    while($row = mysqli_fetch_array($result)) 
        {             
            ...
            echo "<td align='center' style='color: white'><a ?id='$row[0].'>ลบ</a></td> ";
            echo "</tr>";
        }
    echo "</table><br>";
    mysqli_close($conn);
